...
class odom_reader:
  ...
  def __init__(self):
      self.image_sub = rospy.Subscriber("/turtlebot_1/odom",Odometry,self.callback)

  """
  convert an orientation given in quaternions to an actual angle in degrees for a 2D 
  robot
  """
